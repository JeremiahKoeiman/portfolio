...
<section class="col-12">
    <article>
        <h2>Maak een overzicht van alle klanten die NIET voor hun bestelling hebben betaald.</h2>
        <br>

        <?php
        try{
            //SQL statement voorbereiden en uitvoeren
            $query = $db->prepare("SELECT klant.idklant, voornaam, achternaam, gebdatum, adres, postcode, plaats, email, rekeningnummer, bestelling.idbestelling, datum, betaald
                                            FROM klant
